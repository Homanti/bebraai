...
export const models: Model[] = [
    ...
    { name: "Sur AI Assistant", model: "sur", developer: "PollinationsAI", visionSupport: true, provider: "PollinationsAI" },
    { name: "DeepSeek R1", model: "deepseek-r1-0528", developer: "DeepSeek", visionSupport: false, provider: "PollinationsAI" },
